...
def _build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run ai-skills-toolkit full-suite.")
    ...
    parser.add_argument("--test-focus-path", action="append", default=[], help="Optional focus path for engineering chain.")
    parser.add_argument("--output-name", default="skill-full-suite", help="Output file stem.")
    return parser
...
def main() -> int:
    ...
    for item in args.test_focus_path:
        command.extend(["--test-focus-path", item])
